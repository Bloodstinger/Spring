...
@ComponentScans(value = { 
      @ComponentScan("com.online.store.dao"),
      @ComponentScan("com.online.store.service")
    })
public class RootConfig {
   ...
   public LocalSessionFactoryBean getSessionFactory() {
      ...
      factoryBean.setAnnotatedClasses(User.class, Item.class, Order.class, ShoppingCart.class);
      return factoryBean;
   }
